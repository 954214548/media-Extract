package lm.com.audioextract.view.waveview;
                ...
                synchronized (mLockRecDataList) {
                    if (mRecDataList.size() != 0) {
                        try {
                            ...
                            LogUtil.d("volume ", "mRecDataList: " + mRecDataList.size());
                        } catch (Exception e) {
                            //e.printStackTrace();
                            continue;
                        }
...
//                        updateColor();
    ...
    public void updateWaveView(int volume){
        //获取音量大小
        LogUtil.d("volume ", "volume " + volume);
